        ...
        <div className="space-y-6">
          ...
          <section className="space-y-3">
            ...
            <ul className="list-disc pl-6 space-y-2" style={{ color: colors.textSecondary }}>
              ...
              <li><span className="font-semibold" style={{ color: colors.textPrimary }}>Nature of PVs:</span> PVs are digital collectibles tracked on a private ledger. PVs represent sentiment and popularity; they do not represent equity, ownership in a person, rights to future income, voting rights, or a debt owed by any Talent.</li>
          ...
          <section className="space-y-3">
            <h2 className="text-xl font-semibold" style={{ color: colors.textPrimary }}>7. Talent Terms (For Celebrities/Creators)</h2>
            <p style={{ color: colors.textSecondary }}>
            ...
            <ul className="list-disc pl-6 space-y-2" style={{ color: colors.textSecondary }}>
              ...
              <li><span className="font-semibold" style={{ color: colors.textPrimary }}>Compensation:</span> Talent may receive internal credits (PVs) based on trading volume or market cap. These credits are subject to the Phase 1 restriction: they cannot currently be withdrawn for fiat currency.</li>
            </ul>
          </section>
